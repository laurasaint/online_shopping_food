                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @if(auth()->user()->level == 1)
                            <a class="collapse-item" href="{{route("user_all")}}">User</a>
                            <a class="collapse-item" href="{{route("semua_costumer")}}">Costumer</a>
                            <a class="collapse-item" href="{{route("semua_penjual")}}">Penjual</a>
                            <a class="collapse-item" href="{{route("semua_makanan")}}">Makanan</a>
                            <a class="collapse-item" href="{{route("semua_keranjangbelanja")}}">Keranjang</a>
