...
Route::get("keranjangbelanja/buat",[KeranjangBelanjaController::class,'buat'])->name("buat_keranjangbelanja");
Route::post("keranjangbelanja/simpan",[KeranjangBelanjaController::class,'simpan'])->name("simpan_keranjangbelanja");
